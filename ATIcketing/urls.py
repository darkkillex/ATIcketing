...
# Import diretto delle view tickets
from tickets.views import (
    ...
    operator_export_csv,
    team_export_csv,
    ticket_audit_csv,   # export audit del singolo ticket
)
...
urlpatterns = [
    ...
    # Export CSV (nomi "nuovi")
    path('tickets/operator.csv', operator_export_csv, name='operator_export_csv'),
    path('tickets/team.csv', team_export_csv, name='team_export_csv'),

    # 🔁 Alias "legacy" usati dai template (evita NoReverseMatch) - VALUTARE SE RIMUOVERLI
